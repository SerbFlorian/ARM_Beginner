...
typedef struct {
	...
	Q12 input;			/* input temperature value for conversion */
	Q12 xresult;		/* Expected result of the operation */
} test_ops_struct;

/* the list of test case values */
test_ops_struct test_case[] =
	/* Tests Celsius -> Fahrenheit */
{{'C', MAKE_Q12(-273.15), 				/*  0: absolute min. ºC temperature */
	   MAKE_Q12(-459.67)},
 {'C', MAKE_Q12(-40.0), 				/*  1: equal ºC and ºF */
	   MAKE_Q12(-40.0)},
 {'C', MAKE_Q12(-17.7777777777778), 	/*  2: conversion to 0 ºF */
	   MAKE_Q12(0.0)},
 {'C', MAKE_Q12(-17.777), 				/*  3: nearby conversion to 0 ºF */
	   MAKE_Q12(0.0014)},
 {'C', MAKE_Q12(-17.6), 				/*  4: another nearby conversion to 0 ºF */
	   MAKE_Q12(0.32)},
 {'C', MAKE_Q12(-1.125), 				/*  5: small negative ºC (positive ºF) */
	   MAKE_Q12(29.975)},
 {'C', MAKE_Q12(0.0),					/*  6: 0.0 ºC = 32.0 ºF */
	   MAKE_Q12(32.0)},
 {'C', MAKE_Q12(0.000244140625), 		/*  7: minimal fraction in ºC */
	   MAKE_Q12(32.000439453125)},			// result = 32 + converted fract.
 {'C', MAKE_Q12(1.0), 					/*  8: unit ºC */
	   MAKE_Q12(33.8)},
 {'C', MAKE_Q12(31.1), 					/*  9: common positive ºC */
	   MAKE_Q12(87.98)},
 {'C', MAKE_Q12(4500.0), 				/* 10: large positive ºC */
	   MAKE_Q12(8132.0)},
 {'C', MAKE_Q12(291245.4325), 			/* 11: max. convertable ºC */
	   MAKE_Q12(524273.7785)},

	/* Tests  Fahrenheit -> Celsius */
 {'F', MAKE_Q12(-459.67), 				/* 12: absolute min. ºF temperature */
	   MAKE_Q12(-273.15)},
 {'F', MAKE_Q12(-40.0), 				/* 13: equal ºF and ºC */
	   MAKE_Q12(-40.0)},
 {'F', MAKE_Q12(-0.000122070312), 		/* 14: minimal neg. fraction in ºF */
	   MAKE_Q12(-17.7778455946178)},		// result = -17 - converted fract.
 {'F', MAKE_Q12(0.0),					/* 15: 0.0 ºF = -17.777... ºC */
	   MAKE_Q12(-17.7777777777778)},
 {'F', MAKE_Q12(1.0),					/* 16: unit ºF */
	   MAKE_Q12(-17.2222222222222)},
 {'F', MAKE_Q12(31.999), 				/* 17: small converted ºC */
	   MAKE_Q12(-0.0005)},
 {'F', MAKE_Q12(31.9997802734384), 		/* 18: small converted ºC */
	   MAKE_Q12(-0.000122070311999857)},
 {'F', MAKE_Q12(32.0), 					/* 19: 0.0 ºC */
	   MAKE_Q12(0.0)},
 {'F', MAKE_Q12(32.009), 				/* 20: small ºC */
	   MAKE_Q12(0.00500000000000019)},
 {'F', MAKE_Q12(59.0), 					/* 21: common positive ºF */
	   MAKE_Q12(15.0)},
 {'F', MAKE_Q12(451.0), 				/* 22: temperature for burning books*/
	   MAKE_Q12(232.777777777778)},
 {'F', MAKE_Q12(524287.999755859), 		/* 23: max. convertable ºF */
	   MAKE_Q12(291253.333197699)}
};
...
/* Compute a sensible margin for absolute error of Celsius to Fahrenheit or
	...
	Parameters:
		...
		expected_result (Q12):	the expected transformed value
	Result:
		error limit, in absolute Q12 units.
*/
unsigned int error_margin(char scale, int expected_result)
{
	...
	if (scale == 'C')
	{
			/* subtract 200.000 units to expected result, to align the zero
			   ...
			   shift 15 bits to the left, so as to divide corrected result by
				...
				(0.003% is the relative error of representing 9/5 in Q12)
	...
	else // if (scale == 'F')
	{
			/* convert negative into positive results
			   shift 12 bits to the left, so as to divide corrected result by
				...
				(0.02% is the relative error of representing 5/9 in Q12)
