...
#include "Q12.h"				// definició tipus Q12


  	/* declaració del tipus t_maxmin, per retornar resultats */
typedef struct
{	
	Q12 tmin_C;				// temperatura mínima, en graus Celsius
	Q12 tmax_C;				// temperatura màxima, en graus Celsius
	Q12 tmin_F;				// temperatura mínima, en graus Fahrenheit
	Q12 tmax_F;				// temperatura màxima, en graus Fahrenheit
