...
{{'C', 0, MAKE_Q12(19.8),				/*  0: several replicated min and max */
 ...
 {'C', 2, MAKE_Q12(0.2),				/*  2: all values around 0º Celsius */
	...
	/* Tests  for months */
 {'M', 0, MAKE_Q12(3.8),				/*  3: first column (January) */
	{MAKE_Q12(-2.2), MAKE_Q12(13.4),
	 MAKE_Q12(28.0), MAKE_Q12(56.1),
	 1, 0}},
 {'M', 6, MAKE_Q12(2.1),				/*  4: middle column (July) */
	{MAKE_Q12(-18.8), MAKE_Q12(25.9),
	 MAKE_Q12(-1.8), MAKE_Q12(78.6),
	 1, 0}},
 {'M', 11, MAKE_Q12(7.3),				/*  5: last column (Desember) */
	{MAKE_Q12(-3.0), MAKE_Q12(25.9),
	 MAKE_Q12(26.6), MAKE_Q12(78.6),
	 1, 0}}
};
